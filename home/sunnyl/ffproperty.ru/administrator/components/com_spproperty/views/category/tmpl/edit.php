...
<form action="<?php echo Route::_('index.php?option=com_spproperty&view=category&layout=edit&id=' . (int) $this->item->id); ?>" name="adminForm" id="adminForm" method="post" class="form-validate">
