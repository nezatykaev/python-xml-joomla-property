...
jQuery(function ($) {
    //Google Map
    $('.spproperty-gmap-address').after($('<div class="spproperty-gmap-canvas"></div>'));
    $('.spproperty-gmap-canvas').locationpicker({
        location: {latitude: $('.spproperty-gmap-address').data('latitude'), longitude: $('.spproperty-gmap-address').data('longitude')},
        radius: 300,
        inputBinding: {
            locationNameInput: $('.spproperty-gmap-address')
        },
