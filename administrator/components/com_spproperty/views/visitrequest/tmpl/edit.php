...
<form action="<?php echo Route::_('index.php?option=com_spproperty&view=visitrequest&layout=edit&id=' . (int) $this->item->id); ?>" name="adminForm" id="adminForm" method="post" class="form-validate">
    ...
    <input type="hidden" name="task" value="visitrequest.edit" />
