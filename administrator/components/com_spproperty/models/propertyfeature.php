...
class SppropertyModelPropertyfeature extends AdminModel
{
    protected $text_prefix = 'COM_SPPROPERTY';

    public function getTable($name = 'Propertyfeature', $prefix = 'SppropertyTable', $config = array())
    {
    ...
    public function getForm($data = array(), $loadData = true)
    {
        ...
        $form = $this->loadForm('com_spproperty.propertyfeature', 'propertyfeature', array('control' => 'jform', 'load_data' => $loadData));
    ...
    public function loadFormData()
    {
        $data = Factory::getApplication()
            ->getUserState('com_spproperty.edit.propertyfeature.data', array());
