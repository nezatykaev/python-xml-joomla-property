...
class SppropertyTableCategory extends Table
{
    public function __construct(&$db)
    {
        parent::__construct('#__spproperty_categories', 'id', $db);
    }
    ...
    public function store($updateNulls = false)
    {
        ...
        $table = Table::getInstance('Category', 'SppropertyTable');
    ...
    public function check()
    {
        ...
        // Check image path for J4
        if (SppropertyHelper::getVersion() >= 4) {
            $this->image = HTMLHelper::cleanImageURL($this->image)->url;
        }
