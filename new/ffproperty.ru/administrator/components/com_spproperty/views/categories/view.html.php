...
class SppropertyViewCategories extends HtmlView
{
    ...
    public function display($tpl = null)
    {
        ...
        SppropertyHelper::addSubmenu('categories');
    ...
    protected function addToolbar()
    {
        ...
        JHtmlSidebar::setAction('index.php?option=com_spproperty&view=categories');

        ToolbarHelper::title(Text::_('COM_SPPROPERTY') . ': ' . Text::_('COM_SPPROPERTY_TITLE_CATEGORIES'), '');
    }
}
